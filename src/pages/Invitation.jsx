...
const WEDDING = {
  ...
  venue: "Villa Paradiso, Beirut",
  message: "Together with their families, they joyfully invite you to celebrate their union",
}
    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {petals.map(i => (
        <motion.div key={i}
          ...
          initial={{ x: `${Math.random() * 100}vw`, y: -40, rotate: 0, opacity: 0.7 }}
    ...
    <div className="min-h-screen bg-[#0d0a08] text-white overflow-x-hidden relative">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center z-10"
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }}>
          <p className="text-[#c9a96e] tracking-[0.4em] text-xs uppercase mb-6">We're getting married</p>
      ...
      <section className="py-24 px-6 text-center max-w-2xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} viewport={{ once: true }}>
          ...
          <p className="text-white/60 text-lg leading-relaxed font-light italic">"{WEDDING.message}"</p>
