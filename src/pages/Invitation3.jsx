      ...
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 cursor-pointer relative overflow-hidden"
        ...
        <motion.div className="relative z-10 flex flex-col items-center"
          ...
          <motion.div className="relative mb-8"
            ...
            <div className="w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-2" style={{
    ...
    <div className="min-h-screen overflow-x-hidden relative"
      ...
      <section className="py-12 px-6 max-w-xl mx-auto relative z-10">
        <motion.div className="text-center mb-10"
          ...
          <p className="tracking-[0.3em] text-xs uppercase mb-3 font-medium" style={{ color: roseGold }}>{ar ? "قصتنا" : "Our Story"}</p>
